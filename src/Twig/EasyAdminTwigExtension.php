...
use Exception;
use Second\Order\Booking\Booking\Domain\Model\Booking;
...
class EasyAdminTwigExtension extends AbstractExtension
{
    ...
    public function __construct(ConfigManager $configManager, PropertyAccessor $propertyAccessor, EasyAdminRouter $easyAdminRouter, $logoutUrlGenerator, $debug = false)
    {
    ...
    {
        if ($entity instanceof Booking && $entity->isRecurring()) {
            $entity = 'Subscription';
        }
