...
class QueryBuilder
{
     ...
     */
    public function createListQueryBuilder(array $entityConfig, $sortField = null, $sortDirection = null, $dqlFilter = null): ?DoctrineQueryBuilder
    {
     ...
     * @param string|null $dqlFilter
     */
    public function createSearchQueryBuilder(array $entityConfig, $searchQuery, $sortField = null, $sortDirection = null, $dqlFilter = null): ?DoctrineQueryBuilder
    {
        $class = $entityConfig['class'] ?? $entityConfig['search_class'];
     ...
     */
    protected function isDoctrineAssociation(ClassMetadata $classMetadata, $fieldName): bool
    {
        if (null === $fieldName) {
            return false;
        }
        ...
        return str_contains($fieldName, '.') && !array_key_exists($fieldNameParts[0], $classMetadata->embeddedClasses);
    }
}
