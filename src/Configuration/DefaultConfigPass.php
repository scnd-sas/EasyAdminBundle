...
class DefaultConfigPass implements ConfigPassInterface
{
     ...
     * defined explicitly.
     */
    private function processDefaultEntity(array $backendConfig): array
    {
     ...
     */
    private function processDefaultMenuItem(array $backendConfig): array
    {
     ...
     */
    private function processDefaultHomepage(array $backendConfig): array
    {
        $backendHomepage = [];
